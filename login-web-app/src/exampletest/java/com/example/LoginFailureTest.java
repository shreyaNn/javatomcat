...
public class LoginFailureTest {
    ...
    public void testLoginFailure() {
        try {
            ...
            wait.until(ExpectedConditions.presenceOfElementLocated(By.name("username"))).sendKeys("wronguser");
            ...
            // Adjust this to match your actual failure page title or message
            String expectedTitle = "Login Failed";
            wait.until(ExpectedConditions.titleIs(expectedTitle));
            String actualTitle = driver.getTitle();

            Assert.assertEquals(actualTitle, expectedTitle, "Login did not fail as expected");
            System.out.println("Login failed as expected, title matches expected");
        } catch (Exception e) {
